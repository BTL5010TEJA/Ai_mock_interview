        ...
        const response = await ai.models.generateContent({
            ...
            contents: {
                parts: [
                    ...
                    { text: "Analyze this image from a user's webcam during a job interview. Assess for potential malpractice. Is a mobile phone or another unauthorized device visible? Is the user's gaze consistently averted from the screen, suggesting reading from an external source? Is another person visible or reflected? Be strict but fair. Respond ONLY with a JSON object: {\"phoneDetected\": boolean, \"suspiciousGaze\": boolean, \"reason\": string}." }
                ]
            },
            config: {
